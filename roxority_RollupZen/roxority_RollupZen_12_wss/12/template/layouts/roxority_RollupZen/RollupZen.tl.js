...
function roxReloadRollup(textAreaID, wpID, opt, ret) {
	var pager = jQuery('#rox_pager_' + wpID), url = opt.webUrl + '/_layouts/roxority_RollupZen/mash.tl.aspx?dsid=' + opt.dsid + '&tid=' + textAreaID + '&id=' + wpID + '&ps=' + opt.ps + '&p=' + opt.p + '&pmo=' + opt.pmo + '&pst=' + opt.pst + '&psk=' + opt.psk + '&dty=' + opt.dty + '&did=' + opt.did + '&la=' + roxSlimEncode(opt.la) + '&pr=' + opt.pr + '&on=' + opt.on + '&ih=' + opt.ih + '&ls=' + opt.ls + '&v=' + opt.v + '&s=' + opt.s + '&spn=' + opt.spn + '&sd=' + opt.sd + '&tpn=' + opt.tpn + '&tpo=' + opt.tpo + ((opt.tv == null) ? '' : ('&tv=' + opt.tv)) + '&gpn=' + opt.gpn + '&gb=' + opt.gb + '&gs=' + opt.gs + '&gi=' + opt.gi + '&ti=' + opt.ti + '&gid=' + opt.gid + '&gd=' + opt.gd + '&rs=' + opt.rs + '&t=' + opt.t + '&nm=' + opt.nm + '&pm=' + opt.pm + '&f=' + opt.f + '&fa=' + opt.fa + '&fl=' + opt.fl + '&dyn=' + opt.dyn + '&r=' + Math.random();
	roxLastOps[wpID] = [textAreaID, opt];
	if (pager.length)
