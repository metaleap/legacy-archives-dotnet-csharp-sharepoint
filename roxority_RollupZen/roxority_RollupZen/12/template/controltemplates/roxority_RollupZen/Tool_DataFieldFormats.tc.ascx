...
<%@ Register TagPrefix="rox" TagName="ItemEditor" Src="~/_controltemplates/roxority_RollupZen/ItemEditor.tc.ascx" %>
<rox:ItemEditor runat="server" ID="ItemEditor" AsmName="roxority_Shared" FilePath="/_layouts/roxority_RollupZen/schemas.tl.json" SchemaName="DataFieldFormats" />
