...
<%@ Register TagPrefix="rox" TagName="ItemEditor" Src="~/_controltemplates/roxority_UploadZen/ItemEditor.tc.ascx" %>
<rox:ItemEditor runat="server" ID="ItemEditor" AsmName="roxority_Shared" FilePath="/_layouts/roxority_UploadZen/schemas.tl.json" SchemaName="DataFieldFormats" />
