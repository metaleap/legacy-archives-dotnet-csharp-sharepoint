...
namespace roxority_SetupZen {
	...
	public class ExtendedTreeNode : TreeNode {
		...
		private ExtendedTreeNode (string text, bool populateOnDemand, object tag)
			: base (text) {
			base.Tag = tag;
		...
		public bool PreventChildCheck {
			get {
				return preventChildCheck;
			}
			set {
				preventChildCheck = value;
			}
		}

		public bool PreventParentCheck {
			get {
				return preventParentCheck;
			}
			set {
				preventParentCheck = value;
			}
		}
