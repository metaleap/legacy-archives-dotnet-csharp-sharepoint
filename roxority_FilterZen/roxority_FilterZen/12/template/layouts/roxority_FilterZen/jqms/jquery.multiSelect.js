...
if(jQuery) (function($){
	...
	$.extend($.fn, {
		...
		multiSelectOptionsShow: function() {
			...
			// Position it
			var offset = $(this).position(), nuWidth = $(this).width(), maxWidth = Math.abs($(window).width() - 24 - offset.left), minWidth = nuWidth, maxHeight = $(window).height() - 24 - (offset.top + $(this).outerHeight());
