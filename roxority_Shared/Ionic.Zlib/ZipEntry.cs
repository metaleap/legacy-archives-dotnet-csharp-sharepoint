...
namespace Ionic.Zip
{
    ...
    {
		public static event EventHandler ExceptionNotification;
        ...
        internal void WriteCentralDirectoryEntry(System.IO.Stream s)
        {
			...
			Int16 versionNeededToExtract = (Int16) (((_OutputUsesZip64 != null) && _OutputUsesZip64.HasValue && _OutputUsesZip64.Value) ? 45 : 20);
            ...
            int j = 0;
			if ((_OutputUsesZip64 != null) && _OutputUsesZip64.HasValue && _OutputUsesZip64.Value) {
			...
			_presumeZip64 = (_OutputUsesZip64 != null) && _OutputUsesZip64.HasValue && _OutputUsesZip64.Value;
...
#if SILVERLIGHT
				if (commentEncoding.WebName == "IBM437")
#else
        ...
        private void WriteHeader(System.IO.Stream s, int cycle)
        {
            ...
            if
#if SILVERLIGHT
				(ActualEncoding.WebName == System.Text.Encoding.UTF8.WebName)
#else
				(ActualEncoding.CodePage == System.Text.Encoding.UTF8.CodePage)
#endif
				_BitField |= 0x0800;
        ...
        private void _WriteFileData(System.IO.Stream s)
        {
			...
			try {
				...
				if (ExceptionNotification != null)
					ExceptionNotification (ex, EventArgs.Empty);
			}
            finally
            {
			...
			_OutputUsesZip64 = new Nullable<bool> (_zipfile._zip64 == Zip64Option.Always || ((_entryRequiresZip64 != null) && _entryRequiresZip64.HasValue && _entryRequiresZip64.Value));
